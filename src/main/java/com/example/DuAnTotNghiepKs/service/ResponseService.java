...
public class ResponseService {
    ...
    public ResponseService() {
        ...
        responses.put("giá phòng", "Giá phòng dao động từ 1 triệu đến 3 triệu đồng, tùy thuộc vào loại phòng và thời gian đặt.");
        ...
        responses.put("địa chỉ khách sạn", "Khách sạn của chúng tôi nằm tại 123 Đường ABC, Thành phố XYZ.");
        ...
        responses.put("chính sách hủy", "Bạn có thể hủy đặt phòng miễn phí trong vòng 24 giờ trước khi nhận phòng.");
        responses.put("giờ mở cửa", "Khách sạn mở cửa 24/7 để phục vụ bạn.");
        responses.put("tiện nghi", "Chúng tôi có hồ bơi, gym, nhà hàng và dịch vụ đưa đón sân bay.");
        ...
        responses.put("giá vé tham quan", "Giá vé tham quan các địa điểm du lịch gần đây dao động từ 200.000 đến 500.000 đồng.");
        responses.put("dịch vụ đưa đón sân bay", "Chúng tôi cung cấp dịch vụ đưa đón sân bay với mức phí 300.000 đồng/lượt.");
        responses.put("hủy dịch vụ", "Bạn có thể hủy dịch vụ trong vòng 1 giờ trước khi sử dụng.");
        responses.put("hello", "Chào Ban Ban can minh giup van de gi a");
        responses.put("xin chào", "Chào Ban Ban can minh giup van de gi a");
        responses.put("chào", "Chào Ban Ban can minh giup van de gi a");
